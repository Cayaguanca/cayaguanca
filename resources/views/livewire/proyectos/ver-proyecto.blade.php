    ...
    <div class="container-fluid mb-5">
        ...
        <div class="row">
            ...
            <div class="col bordeCuadroDerecho">
                <p><h3>{{ $proyecto->nombre_proyecto }}</h3></p>
                <p>{{ $proyecto->descripcion_proyecto }}</p>
                <p> Fecha de inicio: {{$proyecto->fecha_inicio}}</p>
                <p for="">Fecha final: {{$proyecto->fecha_final}}</p>
                @if($donantes->count())
                    <h3>Donantes del programa</h3>
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                @foreach($detallesAdd as $detalle)
                                    <tr>
                                        <td>{{ $detalle['fecha'] }}</td>
                                        <td>{{ $detalle['direccion_proyecto'] }}</td>
