...
class Tabla extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            Column::make("Id", "id")
                ->sortable(),
            Column::make("Nombre evento", "nombre_evento")
                ->sortable(),
            Column::make("Descripcion evento", "descripcion_evento")
                ->sortable(),
            Column::make('Actions')
                ->label(
                    function ($row, Column $column) {
                        $edit = '<button type="button" data-bs-toggle="modal" data-bs-target="#registrarModal" class="btn">
                        ...
                        $delete = '<button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn">
                        ...
                        $ver = '<button type="button" data-bs-toggle="modal" class="btn">
